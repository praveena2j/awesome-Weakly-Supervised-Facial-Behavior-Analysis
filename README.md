...
This is a curated list of weakly supervised learning methods and datasets for facial behavior analysis, based on our survey: < eakly Supervised Learning for Facial Behavior Analysis: A Review>. This list will continue to be updated, please feel free to nominate good related works with Pull Requests!
