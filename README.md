...
This is a curated list of weakly supervised learning methods and datasets for facial behavior analysis, based on our survey: < Learning>. This list will continue to be updated, please feel free to nominate good related works with Pull Requests!
